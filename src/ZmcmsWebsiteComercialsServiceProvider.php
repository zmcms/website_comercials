<?php
namespace Zmcms\WebsiteComercials;
use Illuminate\Support\ServiceProvider;
class ZmcmsWebsiteComercialsServiceProvider extends ServiceProvider{

	public function register(){
		$this->app->make('Zmcms\WebsiteComercials\Backend\Controllers\ZmcmsWebsiteComercialsController');
		$this->app->make('Zmcms\WebsiteComercials\Frontend\Controllers\ZmcmsWebsiteComercialsController');
	...
	public function boot(){
		...
		$this->publishes([
			__DIR__.'/config' => base_path('config/'.Config('frontend.theme_name').'/zmcms/website_comercials'),
